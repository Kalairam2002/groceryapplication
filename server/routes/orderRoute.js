...
import { getAllOrders, getUserOrders, placeOrderCOD, placeOrderRazorPay, verifyPayment, getOrdersByUser,getOrdersBySeller,getOrderById,getOrderTracking, } from '../controllers/orderController.js';
...
orderRouter.get("/track/:orderId", getOrderTracking); // ✅ Order tracking route — new

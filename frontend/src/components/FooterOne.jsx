    ...
    return (
        <footer className="footer py-50" style={{marginTop:"30px", boxShadow:"0 4px 10px rgba(0,0,0,0.1)" ,  backgroundColor:"#4CAF50",paddingTop:"40px"}}>
            ...
            <div className="container container-lg">
                <div className="footer-item-wrapper d-flex  justify-content-between flex-wrap">
                    ...
                    <div className="footer-item">
                        <h6 className="footer-item__title">Vendor</h6>
                        <ul className="footer-menu">
                            ...
                            {/* <li className="mb-16" >
                                <Link to="/privacy" className="text-white hover:text-gray-200 transition-colors duration-300" >
                                    Privacy Policy
                                </Link>
                            </li> */}
                            <li className="mb-16" >
